...
class PeakSoFarResponse(BaseModel):
    date: str
    range: Dict[str, Optional[str]]
    peak_hour: Optional[int]
    peak_avg_percentage: Optional[float]
...
@app.get("/analysis/peak-so-far", response_model=PeakSoFarResponse)
async def peak_so_far_today(
